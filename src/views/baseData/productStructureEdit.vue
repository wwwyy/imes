 ...
 <el-row type="flex" class="row-bg" justify="center">
   ...
   <el-col :span="6">
     <el-form-item label="有效期：		">
       <el-date-picker style="width:100%;" v-model="value1" type="date" placeholder="选择日期">
       </el-date-picker>
     </el-form-item>
   </el-col>
 </el-row>
...
<script>
 ...
 return {
   ...
   v: "V1.149",
   codeTypeList: [{
       value: "WH_AREA(WH_AREA)",
       label: "WH_AREA(WH_AREA)"
     },
     {
       value: "库区(WH_AREA)",
       label: "库区(WH_AREA)"
     ...
     {
       value: "bom物料类型(BOM_MATERIAL_TYPE)",
       label: "bom物料类型(BOM_MATERIAL_TYPE)"
     },
     {
       value: "数据来源(STRUCTURE_SOURCE)",
       label: "数据来源(STRUCTURE_SOURCE)"
     },
     {
       value: "移动原因(MOVE_REASON)",
       label: "移动原因(MOVE_REASON)"
     }
   ],
   markOptions: [{
       value: "1",
