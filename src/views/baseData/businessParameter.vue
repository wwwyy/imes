<template>
    <div id="businessParameter">
        ...
        <div style="text-align:center;margin:20px 0;">
             <span style="line-height:32px;font-size:14px;">参数代码：</span>
            <el-input v-model="copyCode" placeholder="请输入内容" style="width:194px" size="small"></el-input>
            <span style="margin-left:40px;line-height:32px;font-size:14px;">参数名称：</span>
             <el-input v-model="copyName" placeholder="请输入内容" style="width:194px" size="small"></el-input>
            <span style="margin-left:40px;line-height:32px;font-size:14px;">参数类型：</span>
...
export default {
    ...
    methods: {
        add(){
		  this.$router.push('businessParameterAdd')
	  },
      handleClick(row) {
        console.log(row);
        this.$router.push('businessParameterEdit')
      },
