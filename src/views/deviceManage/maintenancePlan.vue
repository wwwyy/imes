<template>
    <div id="maintenancePlan">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>维保计划维护</el-breadcrumb-item>
        </el-breadcrumb>
        <hr>
        ...
        <div style="text-align:left;margin:20px 0;">
             <span style="display:inline-block;line-height:32px;font-size:14px;width:70px">单号ID：	</span>
            ...
            <br>
            <br>
             <span style="display:inline-block;line-height:32px;font-size:14px;width:70px">设备名称：</span>
            <el-input v-model="copyCode" placeholder="请输入内容" style="width:194px" size="small"></el-input>
...
export default {
    ...
    methods: {
      add(){
		  this.$router.push('maintenancePlanAdd')
	  },
      handleClick(row) {
        console.log(row);
        this.$router.push('maintenancePlanEdit')
      },
