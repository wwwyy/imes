<template>
    <div id="qualityInspectionGrade">
        ...
        <div style="text-align:left;margin:20px 0;">
            ...
            <span style="display:inline-block;margin-left:40px;line-height:32px;font-size:14px;width:70px;">质检结果：</span>
                <el-select v-model="copyType" placeholder="请选择" size="small" style="width:194px">
                <el-option
                v-for="item in copyOptions"
                :key="item.value"
