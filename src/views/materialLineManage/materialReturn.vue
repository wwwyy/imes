<template>
    <div id="materialReturn">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>退料管理</el-breadcrumb-item>
        </el-breadcrumb>
        <hr>
        <div style="text-align:left">
            ...
            <el-button size="small"  style="width:100px"> 确 认 </el-button>
        ...
        <div style="text-align:left;margin:20px 0;">
              <span style="margin-left:40px;display:inline-block;line-height:32px;font-size:14px;width:90px">出库单号：	</span>
            <el-input v-model="copyCode" placeholder="请输入内容" style="width:194px" size="small"></el-input>
              <span style="display:inline-block;margin-left:40px;line-height:32px;font-size:14px;width:90px;">出库仓库：</span>
            ...
            <br>
            <br>
            <span style="display:inline-block;margin-left:40px;line-height:32px;font-size:14px;width:90px;">出库日期从：</span>
             <el-date-picker
                v-model="startDate"
                type="date"
                placeholder="选择日期"
             ...
             <span style="display:inline-block;margin-left:40px;line-height:32px;font-size:14px;width:90px;">出库日期到：</span>
             <el-date-picker
                v-model="endDate"
                type="date"
                placeholder="选择日期"
...
export default {
    ...
    methods: {
        add(){
		  this.$router.push('materialReturnAdd')
	  },
      handleClick(row) {
        console.log(row);
        this.$router.push('materialReturnEdit')
      },
